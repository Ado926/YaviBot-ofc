...
┗━━━━━━━━━━━━━━━━━━⬣\n`
    regbot += `•✩.･*:｡≻──── ⋆♡⋆ ────.•*:｡✩•\n`
    regbot += `*「ツ」𝐍𝐨𝐦𝐛𝐫𝐞:* ${name}\n`
    regbot += `*「ツ」𝐄𝐝𝐚𝐝:* ${age} años\n`
    regbot += `•✩.･*:｡≻──── ⋆♡⋆ ────.•*:｡✩•\n`
    regbot += `*「✐」𝐑𝐞𝐜𝐨𝐦𝐩𝐞𝐧𝐬𝐚𝐬:*\n> `
    regbot += `• 15 Estrellas 🌟\n> `
    regbot += `• 5 YaviCoins 🪙\n> `
  ...
  await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
            externalAdReply: {
                title: '⊱『✅𝆺𝅥 𝗥𝗘𝗚𝗜𝗦𝗧𝗥𝗔𝗗𝗢(𝗔) 𝆹𝅥✅』⊰ 𝗕𝗜𝗘𝗡𝗩𝗘𝗡𝗜𝗗@ 𝐀 𝐋𝐀 𝐅𝐀𝐌𝐈𝐋𝐈𝐀 :𝐃 𓆸',
                thumbnailUrl: 'https://qu.ax/qnkJu.jpg',
                mediaType: 1,
...
*BIENVENID@ A LA FAMILY!! :D*`;
    ...
    let channelID = '120363402846939411@newsletter';
        ...
        contextInfo: {
            externalAdReply: {
                title: "【 🔔 ✰ 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 𝐃𝐄 𝐑𝐄𝐆𝐈𝐒𝐓𝐑𝐎 𝗝𝗦𝗝𝗦𝗝 ✰ 🔔 】",
                body: '🥳 ¡ᴜɴ ɴᴜᴇᴠᴏ miembro ʀᴇɢɪsᴛʀᴀᴅᴏ!!! ',
                thumbnailUrl: perfil,
                sourceUrl: redes,
                mediaType: 1,
