...
const vid = ['https://qu.ax/OKUYL.mp4'].getRandom();

const defaultMenu = {
  before: `*•:•:•:•:•:•:•:•:•:•☾☼☽•:•.•:•.•:•:•:•:•:•*

"「💓」 Holaaa *%name* %greeting, Para Ver Tu Perfil Usa *#perfil* :3 ❒"\n
*Heyyyy esperaa te invito a mi nuevo sv de MultiCraft :D Codigo: 2FTX6AEU*\n
_Nota: El server esta re solo ps es nuevo pero pueden ir entrando pa avanzar xd, hace falta spawn yy mas :v.._\n 
* Si no tienes MultiCraft aqui tienes el link de descarga: https://play.google.com/store/apps/details?id=com.multicraft.game*\n 
*_Si te lo descargas no olvides visitar mi sv XD_*\n
╔━━━━━ *⊱𝐈𝐍𝐅𝐎 - 𝐁𝐎𝐓⊰*
✦  👤 *Cliente:* %name
✦  ᥫ᭡ *Modo:* Privado Vip
✧  ✨ *Baileys:* Multi Device
✦  𖨆 *Tiempo Activo:* %uptime
✧  ✰ *Usuarios:* %totalreg 
╚━━━━━━━━━━━━━━
%readmore
...
let botinfo = (conn.user.jid == global.conn.user.jid ? '𝕆𝕗𝕚𝕔𝕚𝕒𝕝' : 'ʂυႦ-Ⴆσƚ');
