...
mobile: MethodMobile, 
browser: opcion == '1' ? ['YaviBot', 'Edge', '20.0.04'] : methodCodeQR ? ['YaviBot', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
if (opts['autocleartmp'] && (global.support || {}).find) (tmp = [os.tmpdir(), 'tmp', "Jadibots"], tmp.forEach(filename => cp.spawn('find', [filename, '-amin', '2', '-type', 'f', '-delete'])))}, 30 * 1000)}
...
if (connection == 'open') {
console.log(chalk.bold.greenBright(`\n❒⸺⸺⸺⸺【• CONECTADO •】⸺⸺⸺⸺❒\n│\n│ 🟢 Se ha conectado con WhatsApp exitosamente :D\n│\n❒⸺⸺⸺⸺【• CONECTADO •】⸺⸺⸺⸺❒`))}
...
console.log('🍭 YaviBot no tiene Sub-Bots vinculados.');
return;
}
...
console.log(chalk.bold.greenBright(` YaviBotconectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🥀 Error al iniciar YaviBot: `, error))
}
})();
